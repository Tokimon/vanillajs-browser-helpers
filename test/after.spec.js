...
describe('"after"', () => {
  ...
  it('Should ignore and return NULL for the <HTML> element', () => {
    ...
    expect(_after(document.documentElement, testUtils.create('div'))).to.be.null;
